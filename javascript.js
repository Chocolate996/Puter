//nav高度
var get_nav_h =
  parseFloat(getComputedStyle(document.querySelector(".nav")).height) +
  parseFloat("30") +
  "px";
...
//bluebox宽度
var get_bluebox_w = parseFloat(
  getComputedStyle(document.querySelectorAll(".bluebox")[1]).width
);
var get_bluebox_content_w_1 = parseFloat(
  getComputedStyle(document.querySelectorAll(".bluebox-code-content")[0]).width
);
var get_bluebox_content_h_1 = parseFloat(
  getComputedStyle(document.querySelectorAll(".bluebox-code-content")[0]).height
);
var get_bluebox_content_w_2 = parseFloat(
  getComputedStyle(document.querySelectorAll(".bluebox-code-content")[1]).width
);
var get_bluebox_content_h_2 = parseFloat(
  getComputedStyle(document.querySelectorAll(".bluebox-code-content")[1]).height
);
...
document.documentElement.style.setProperty(
  "--bluebox-code-outside-w-hover",
  out_bluebox_code_outside_w_hover
);
document.documentElement.style.setProperty(
  "--bluebox-code-left-hover",
  out_bluebox_code_left
);
let arr3 = document.getElementsByClassName("bluebox-code");
for (let i = 0, len = arr3.length; i < len; i++) {
  document.getElementsByClassName("bluebox-code")[i].style.width =
    out_bluebox_code_w;
  document.getElementsByClassName("bluebox-code-outside")[i].style.height =
    out_bluebox_code_outside_h;
}
